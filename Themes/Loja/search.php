...
<body>
    ...
    <h1 class="font-text-max font-weight-max color-white text-margin title-folder">Resultado da pesquisa</h1>
    ...
    <div class="container_exposed radius">
        ...
        <div class="exposed bgcolor-white-light border radius">
            ...
            <h3 class="product_title color-blue-dark text_shadow font-medium">
