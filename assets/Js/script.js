$(document).ready(
    ...
    $('#btn_open_cart').click(
        function(){
            $('#container_cart').animate({top: "45%"},700)
    ...
    $('#btn_close_cart').click(
        function(){
            $('#container_cart').animate({top: "-100%"},700)
    ...
    $('#btn_open_recovery').click(
        function(){
            $('#container_login').animate({top: "-100%"},700)
            $("#container_login").css("pointer-events", "none")
            $('#modal_container_recovery').animate({top: "30%"},300)
            $('#modal_container_recovery').css("pointer-events", "all")
        }
    )
    $('#send_recovery').click(
        function(){
            $('#modal_container_recovery').animate({top: "-100%"},700)
            $("#modal_container_recovery").css("pointer-events", "none")
            $('#container_new_password').animate({top: "30%"},300)
